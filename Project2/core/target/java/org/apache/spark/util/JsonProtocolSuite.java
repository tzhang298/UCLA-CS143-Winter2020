...
public  class JsonProtocolSuite extends org.scalatest.FunSuite {
   ...
   */
  private  org.apache.spark.executor.TaskMetrics makeTaskMetrics (long a, long b, long c, long d, int e, int f, boolean hasHadoopInput, boolean hasOutput) { throw new RuntimeException(); }
  /** --------------------------------------- *
