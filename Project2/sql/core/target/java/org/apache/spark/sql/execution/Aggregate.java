...
public  class Aggregate extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryNode, scala.Product, scala.Serializable {
  ...
  // no position
  public  class ComputedAggregate$ extends scala.runtime.AbstractFunction3<org.apache.spark.sql.catalyst.expressions.AggregateExpression, org.apache.spark.sql.catalyst.expressions.AggregateExpression, org.apache.spark.sql.catalyst.expressions.AttributeReference, org.apache.spark.sql.execution.Aggregate.ComputedAggregate> implements scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.expressions.AggregateFunction[] newAggregateBuffer () { throw new RuntimeException(); }
  /**
